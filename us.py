class Vehiculo:
    ...
    def detener(self):
        print(f"El vehículo {self.get_marca()} {self.get_modelo()} está detenido.")
...
class Auto(Vehiculo):
    ...
    def detener(self):
        print(f"El auto {self.get_marca()} {self.get_modelo()} ha frenado.")
...
class Motocicleta(Vehiculo):
    ...
    def detener(self):
        print(f"La motocicleta {self.get_marca()} {self.get_modelo()} está detenida.")
...
class Camion(Vehiculo):
    ...
    def detener(self):
        print(f"El camión {self.get_marca()} {self.get_modelo()} está detenido.")
...
if __name__ == "__main__":
    vehiculos = {
        ...
        "Actros": Camion("Mercedes-Benz", "Actros", 2021, 25),
    }
